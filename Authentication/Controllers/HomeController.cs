    ...
    public class HomeController : Controller
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            try
            {
                ...
                string userProfileCookie = context.HttpContext.Request.Cookies["EnUserId"];

                if (userProfileCookie != null && !string.IsNullOrEmpty(userProfileCookie))
                {
                    var cookieUserId = userProfileCookie;
                ...
                else
                {
                    ...
                    {
                        context.HttpContext.Response.Cookies.Append("EnUserId", "3", new CookieOptions
